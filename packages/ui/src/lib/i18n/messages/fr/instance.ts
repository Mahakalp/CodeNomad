export const instanceMessages = {
  ...
  "instanceShell.connection.reconnecting": "Reconnexion ({count})...",
  "instanceShell.connection.retry": "Réessayer",
  "instanceShell.connection.retryHint": "Nouvelle tentative dans {seconds}s",
