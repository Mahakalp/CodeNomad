export const instanceMessages = {
  ...
  "instanceShell.connection.reconnecting": "Reconectando ({count})...",
  "instanceShell.connection.retry": "Reintentar",
  "instanceShell.connection.retryHint": "Siguiente intento en {seconds}s",
